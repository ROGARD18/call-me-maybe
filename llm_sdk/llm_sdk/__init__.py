...
class Small_LLM_Model:
    """Wrapper around a lightweight causal language model."""
    ...
    def encode(self, text: str) -> torch.Tensor:
        """Tokenise text and return a 2-D input-id tensor."""
    ...
    def get_logits_from_input_ids(self, input_ids: list[int]) -> list[float]:
        """Return next-token logits for the provided prefix ids."""
    ...
    def get_path_to_vocab_file(self) -> str:
        """Return the path to the tokenizer vocabulary file."""
    ...
    def get_path_to_vocabulary_json(self) -> str:
        """Return the vocabulary path expected by the project spec."""
        return self.get_path_to_vocab_file()

    def get_path_to_merges_file(self) -> str:
        """Return the path to the tokenizer merges file."""
    ...
    def get_path_to_tokenizer_file(self) -> str:
        """Return the path to the tokenizer JSON file."""
